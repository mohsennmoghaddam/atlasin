                        ...
                        <form action="{{ route('team-members.update', $teamMember) }}" method="POST"
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="name_fa" class="form-control form-control-sm"
                                           value="{{ $teamMember->getTranslation('name', 'fa') }}" required>
                                </div>

                                <div class="col-md-6">
                                    <label class="form-label">نام (انگلیسی)</label>
                                    <input type="text" name="name_en" class="form-control form-control-sm"
                                           value="{{ $teamMember->getTranslation('name', 'en') }}">
                                </div>

                                <div class="col-md-6">
                                    <label class="form-label">سمت (فارسی)</label>
                                    <input type="text" name="position_fa" class="form-control form-control-sm"
                                           value="{{ $teamMember->getTranslation('position', 'fa') }}" required>
                                </div>

                                <div class="col-md-6">
                                    <label class="form-label">سمت (انگلیسی)</label>
                                    <input type="text" name="position_en" class="form-control form-control-sm"
                                           value="{{ $teamMember->getTranslation('position', 'en') }}">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="mobile" class="form-control form-control-sm"
                                           value="{{ $teamMember->mobile }}">
                                </div>

                                <div class="col-md-6">
                                    <label class="form-label">شماره داخلی</label>
                                    <input type="text" name="internal_number" class="form-control form-control-sm"
                                           value="{{ $teamMember->internal_number }}">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    @if($teamMember->image)
                                        <img src="{{ asset('storage/' . $teamMember->image) }}" width="60"
