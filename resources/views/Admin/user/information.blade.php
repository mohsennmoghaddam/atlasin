            ...
            <div class="col-12">
                ...
                <form class="file-upload" action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="email" class="form-control" id="inputEmail4"
                                               value="{{$AdminUserProfile->email}}" name="email">
                                    </div>
                                    <!-- birthday -->
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="" aria-label="Phone number"
                                               value="{{$AdminUserProfile->address}}" name="address">
                                    </div>
                                </div> <!-- Row END -->
                            </div>
                        </div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="square position-relative display-2 mb-3">
                                            ...
                                            <img src="{{str_replace('public', '/storage', $AdminUserProfile->image)}}"
                                                 width="80 px" style="margin-top: 10px">
                                        </div>
                                        <!-- Button -->
                                        ...
                                        <!-- Content -->
                                        <p class="text-muted mt-3 mb-0"><span class="me-1">نکته:</span>عکس پروفایل کاربر
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="gap-3 d-md-flex justify-content-md-end text-center bg-secondary-soft">
                        ...
                        <button type="submit" class="btn btn-danger-soft btn-lg" style="margin: auto;">ثبت یا تغییر در
                            پروفایل کاربر
                        </button>
                    </div>
                    <br>
                ...
                @if(auth()->user()->role->hasPermission('update-role'))
                    <div class="row g-1">
                        ...
                        <form method="post" action="{{route('user.update',$user->id)}}">
                            ...
                            <div class="gap-3 d-md-flex justify-content-md-end text-center bg-secondary-soft">
                                {{--                        <button type="submit" class="btn btn-danger btn-lg">Delete profile</button>--}}
                                <button type="submit" class="btn btn-danger-soft btn-lg" style="margin:auto; ">تغییر نقش
                                    کاربر
                                </button>
                            </div>
                        </form>
                    ...
                    <table class="table">
                        ...
                        @foreach($files as $file)
                            <tr class="table-primary">
                                ...
                                <td>{{$file->name}}</td>
                                <td>{{$file->date}}</td>
                                <td><a href="{{str_replace('public', '/storage', $file->file)}}" download><i
            ...
            <div class="col-4" style="text-align: center; margin: initial;">
                <div class="bg-secondary-soft px-4 py-5 rounded">
                    <div class="card g-3">
                        ...
                        <div class="text-center">
                            <div class="card-body">
                                <form action="{{route('PdfStore' ,$AdminUserProfile)}}" method="post"
