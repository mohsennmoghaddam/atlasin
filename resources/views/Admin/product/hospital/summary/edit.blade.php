    ...
    <div class="container mt-4" dir="rtl">
        ...
        <form action="{{ route('hospital-summaries.update', $item) }}" method="POST" id="summary-form">
            ...
            <div class="mb-3">
                ...
                <textarea id="body-fa" name="body[fa]" class="form-control" rows="6"
                          required>{!! $item->body['fa'] ?? '' !!}</textarea>
            </div>
            <div class="mb-3" dir="ltr">
                <label class="form-label">Body (EN)</label>
                <textarea id="body-en" name="body[en]" class="form-control" rows="6"
                          required>{!! $item->body['en'] ?? '' !!}</textarea>
            </div>
