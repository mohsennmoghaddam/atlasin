...
@section('content')
    <div class="container mt-4" dir="rtl">
        <h4 class="text-center mb-3">ایجاد سکشن متن (محصولات بیمارستانی)</h4>

        <form action="{{ route('hospital-texts.store') }}" method="POST" id="text-form" novalidate>
            @csrf

            <div class="mb-3">
                <label class="form-label">کلید (مثال: intro)</label>
