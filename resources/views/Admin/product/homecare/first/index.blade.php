                        ...
                        <table class="table table-bordered table-hover align-middle text-center">
                            ...
                            @foreach($homecare as $section)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('homecare.destroy', $section) }}" method="POST"
                        ...
                        <table class="table table-bordered table-hover align-middle text-center">
                            ...
                            @foreach($sliders as $homecare_slider)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset('storage/' . $homecare_slider->image) }}" width="100"
                                    ...
                                    <td>
                                        <a href="{{ route('homecare-sliders.edit', $homecare_slider->id) }}"
                                           class="btn btn-sm btn-warning">ویرایش</a>
                                    </td>
                                    <td>
                                        <form action="{{ route('homecare-sliders.destroy', $homecare_slider) }}"
                        ...
                        <table class="table table-bordered table-hover align-middle text-center">
                            ...
                            @foreach($cards as $homecare_card)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset('storage/' . $homecare_card->icon) }}" width="100"
                                             height="60" class="rounded">
                                    </td>
                                    <td>{{ $title['fa'] ?? '' }}</td>
                                    <td>{{ $title['en'] ?? '' }}</td>
                                    ...
                                    <td>
                                        <a href="{{ route('homecare-cards.edit', $homecare_card->id) }}"
                                           class="btn btn-sm btn-warning">ویرایش</a>
                                    </td>
                                    <td>
                                        <form action="{{ route('homecare-cards.destroy', $homecare_card) }}"
                                              method="POST" onsubmit="return confirm('آیا مطمئن هستید؟');">
                                            @csrf
                                            @method('DELETE')
                                            <button class="btn btn-sm btn-danger" type="submit">حذف</button>
                        ...
                        <table class="table table-bordered table-hover align-middle text-center">
                            ...
                            @foreach($texts as $t)
                                <tr>
                                    ...
                                    <td>{{ $t->title['en'] ?? '-' }}</td>
                                    <td>{{ $t->order }}</td>
                                    <td><a href="{{ route('homecare-texts.edit',$t) }}" class="btn btn-sm btn-warning">ویرایش</a>
                                    </td>
                                    <td>
                                        <form action="{{ route('homecare-texts.destroy',$t) }}" method="POST"
                        ...
                        <table class="table table-bordered table-hover align-middle text-center">
                            ...
                            @foreach($features as $f)
                                <tr>
                                    <td>{{ $f->id }}</td>
                                    <td>@if($f->image)
                                            <img src="{{ asset('storage/'.$f->image) }}" width="70" height="70"
                                    ...
                                    <td>@if($f->catalog)
                                            <a target="_blank" href="{{ asset('storage/'.$f->catalog) }}"
                                               class="btn btn-info btn-sm">دانلود</a>
                                        @endif</td>
                                    <td>{{ $f->order }}</td>
                                    <td><a href="{{ route('homecare-features.edit',$f) }}"
                                           class="btn btn-warning btn-sm">ویرایش</a></td>
                                    <td>
                                        <form action="{{ route('homecare-features.destroy',$f) }}" method="POST"
                                              onsubmit="return confirm('حذف شود؟')">
                                            @csrf @method('DELETE')
                        ...
                        <table class="table table-bordered table-hover align-middle text-center">
                            ...
                            @foreach($maskCategories as $c)
                                <tr>
                                    ...
                                    <td>{{ $c->items_count }}</td>
                                    <td>{{ $c->order }}</td>
                                    <td><a href="{{ route('homecare-mask-category.edit', $c) }}"
                                           class="btn btn-warning btn-sm">ویرایش</a></td>
                                    <td>
                                        <form action="{{ route('homecare-mask-category.destroy', $c) }}" method="POST"
                                              onsubmit="return confirm('حذف شود؟')">
                                            @csrf @method('DELETE')
                                            <button class="btn btn-danger btn-sm">حذف</button>
                                        </form>
