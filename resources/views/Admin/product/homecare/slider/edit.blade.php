...
@section('content')
    <div class="container mt-5" dir="rtl">
        ...
        <form action="{{ route('homecare-sliders.update', $homecare_slider->id) }}" method="POST"
            ...
            <div class="mb-3">
                ...
                <input type="text" name="title[fa]" value="{{ $homecare_slider->title['fa'] ?? '' }}"
                       class="form-control" required>
            </div>

            <div class="mb-3">
                <label class="form-label">عنوان (English)</label>
                <input type="text" name="title[en]" value="{{ $homecare_slider->title['en'] ?? '' }}"
                       class="form-control" required>
            </div>

            <div class="mb-3">
                <label class="form-label">زیرعنوان (فارسی)</label>
                <input type="text" name="subtitle[fa]" value="{{ $homecare_slider->subtitle['fa'] ?? '' }}"
                       class="form-control">
            </div>

            <div class="mb-3">
                <label class="form-label">زیرعنوان (English)</label>
                <input type="text" name="subtitle[en]" value="{{ $homecare_slider->subtitle['en'] ?? '' }}"
                       class="form-control">
            </div>
