                    ...
                    <div class="card-body">
                        <form action="{{route('CourseCategories.update', $CourseCategory)}}" method="post">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" name="title" class="form-control" placeholder="" id="name"
                                       value="{{$CourseCategory->title}}">

                                <label class="form-label" for="">اصلاح دسته بندی </label>
                                <select name="course_categories_id" id="course_categories_id"
                                        class="form-control sidebar-item">
                                    <option value="{{$CourseCategory->course_categories_id}}">اصلاح دسته بندی اصلی
                                    </option>
