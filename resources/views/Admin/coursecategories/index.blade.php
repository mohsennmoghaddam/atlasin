        ...
        <div class="row text-center">
            <div style="padding-top:50px;">
                <div class="col-10 col-xl-8 col-sm" style="margin: auto;">
                            ...
                            @foreach($CoursesCategories as $CourseCategory)
                                <tr class="table-primary">
                                    ...
                                    <td class="table-action">
                                        <a href="{{route('CourseCategories.edit', $CourseCategory)}}"><i
                                                    class="tf-icon bx bx-edit "></i></a>
                                    </td>
                                    <td>
                                        <form class="form-group"
                                              action="{{route('CourseCategories.destroy', $CourseCategory)}}"
                                              method="post">
                                            @csrf
                                            @method('DELETE')
                                            {{----}}
                    ...
                    <a href="{{route('CourseCategories.create')}}" class="btn btn-success mt-4"><i
                                class="tf-icon bx bx-plus-circle"></i>ایجاد دسته بندی (موضوعات) دوره ها </a>
                </div>
            </div>
        </div>
        <script>
