...
@section('content')
    ...
    @if($schematic)
        <section class="container my-5 text-center">
            <img src="{{ asset('storage/'.$schematic->image) }}"
                 ...
                 style="max-height:580px; object-fit:cover; width:100%;" alt="">
        </section>
    @endif
            ...
            @foreach($stages as $i => $st)
                ...
                <div class="row g-4 align-items-center mb-5 {{ $reverse ? 'flex-row-reverse' : '' }}"
                    ...
                    <div class="col-lg-5 text-center">
                        @if($st->image)
                            <img src="{{ asset('storage/'.$st->image) }}" class="rounded-3 shadow w-100"
                                 style="max-height:360px;object-fit:cover" alt="">
                        @endif
                    </div>
                    <div class="col-lg-7">
                        @if($t)
                        ...
                        @endif
                        <div class="{{ $locale=='fa'?'text-secondary text-justify text-end':'text-secondary text-start' }}"
    ...
    @if($gallery && $gallery->count())
        ...
        <style>
            ...
            .hc-gallery-card:hover .hc-gallery-img {
