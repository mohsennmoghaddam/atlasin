...
@section('content')
                ...
                @foreach($textSections as $section)
                    ...
                    <section class="py-5 text-center">
                        <div class="mx-auto" style="max-width: 900px;">
                            ...
                            @endif
                            <div class="text-secondary" style="line-height: 1.9; text-align: justify;">
                                {!! $body !!}
                            </div>
                        </div>
                    </section>
        ...
        <div class="container my-5" dir="rtl">
            <h3 class="fw-bold text-center mb-4">محصولات بیمارستانی</h3>
            <div class="row g-4 justify-content-center">
                @foreach($categories as $cat)
                    @php
                        $title = $cat->title['fa'] ?? '';
                        $subtitle = $cat->subtitle['fa'] ?? '';
                    @endphp
                    ...
                    <div class="col-6 col-md-3">
                        ...
                        <div class="position-relative mx-auto icon-card">
                                <img src="{{ asset('storage/'.$cat->icon) }}" alt="" class="w-100 h-100 rounded-circle object-cover shadow">
                                <div class="icon-overlay rounded-circle d-flex flex-column justify-content-center align-items-center text-white text-center p-3">
                                    ...
                                    @if($subtitle)<div class="small opacity-75">{{ $subtitle }}</div>@endif
                                </div>
                            </div>
                        </a>
                    </div>
        ...
        <style>
            .icon-card{ width: 180px; height: 180px; }
            ...
            .icon-card:hover .icon-overlay{ opacity:1; }
        </style>
