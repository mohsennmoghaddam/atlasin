        ...
        <div class="row">
            <div class="col-lg-12 mb-4 order-0">
                <div class="card">
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body d-flex align-items-center justify-content-between" style="direction: rtl">
                                <div>
                                ...
                                <div style="margin-left: 100px">
                                    <img
                                        src="{{ $currentUser->avatar ? asset('storage/' . $currentUser->avatar) : asset('admin/assets/img/avatars/default.png') }}"
                                        alt="پروفایل"
                                        width="80"
                                        height="80"
                                        class="rounded"
                                        ...
                                        <ul class="p-0 m-0">
                                            @forelse($hospitals as $hospital)
                                                <li class="d-flex mb-4 pb-1 border-bottom">
                                                    <div class="avatar flex-shrink-0 me-3">
                                                        <img src="{{ asset('storage/' . $hospital->image) }}" alt="{{ $hospital->name }}" class="rounded" width="40" height="40">
                                                    </div>
                                                    <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                        <div class="me-2">
                                                        ...
                                                        <div class="user-progress d-flex align-items-center gap-1">
                                                            <a href="{{ route('hospitals.edit', $hospital) }}" class="btn btn-sm btn-primary">ویرایش</a>
                                                            <form action="{{ route('hospitals.destroy', $hospital) }}" method="POST" onsubmit="return confirm('حذف شود؟')">
                                                                @csrf
                                                                @method('DELETE')
                                                ...
                                                <li class="d-flex mb-4 pb-1 border-bottom">
                                                    ...
                                                    <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                        ...
                                                        <div class="user-progress d-flex align-items-center gap-1">
                                                            ...
                                                            <form action="{{ route('users.destroy', $user) }}" method="POST" onsubmit="return confirm('حذف شود؟')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button class="btn btn-sm btn-danger ms-1">حذف</button>
                                                            </form>
