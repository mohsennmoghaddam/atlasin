                        ...
                        <table class="table table-bordered table-hover text-center align-middle">
                            ...
                            @foreach($sliders as $slider)
                                <tr>
                                    ...
                                    <td>
                                        @if($slider->image)
                                            <img src="{{ asset('storage/' . $slider->image) }}" alt="image" width="80" class="rounded shadow-sm">
                                        @else
                                    ...
                                    <td>
                                        <form action="{{ route('slider.destroy', $slider) }}" method="POST" onsubmit="return confirm('آیا از حذف اسلایدر مطمئن هستید؟');">
                                            @csrf
                                            @method('DELETE')
