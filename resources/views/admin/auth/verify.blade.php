...
{{--                <h2 class="text-xl font-bold text-gray-800">تایید کد یک‌بارمصرف</h2>--}}
{{--                <p class="text-sm text-gray-500 mt-1">رمز مخفی + کد پیامک‌شده را وارد کنید</p>--}}
{{--            </div>--}}
...
{{--            <form action="{{ route('login.verifyOtp') }}" method="POST" class="space-y-4">--}}
{{--                @csrf--}}

{{--                <div>--}}
{{--                    <label for="code" class="block text-sm font-medium text-gray-700">رمز مخفی + کد OTP</label>--}}
{{--                    <input type="text" name="code" id="code" required--}}
{{--                           class="mt-1 w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-right text-gray-800" />--}}
{{--                </div>--}}
    ...
    <form method="POST" action="{{ route('login.verifyOtp') }}">
        ...
        <div class="con">
            <header class="head-form">
                <h2>تایید هویت</h2>
                <p>کد ارسال‌شده و رمز مخفی را وارد کنید</p>
            </header>
            ...
            <div class="field-set">
                ...
                <input class="form-input" type="text" name="code" placeholder="کد ارسال‌شده" required>

{{--                <span class="input-item">--}}
{{--                    <i class="fa fa-shield-alt"></i>--}}
{{--                </span>--}}
{{--                <input class="form-input" type="text" name="secret_code" placeholder="رمز مخفی (مثلاً AT61)" required>--}}

                @error('otp_code') <p class="text-danger mt-1">{{ $message }}</p> @enderror
                @error('secret_code') <p class="text-danger mt-1">{{ $message }}</p> @enderror

                <br>
                <button type="submit" class="log-in">مرحله بعد</button>
            </div>
        </div>
    </form>
</div>
