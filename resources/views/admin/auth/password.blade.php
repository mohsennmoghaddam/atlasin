...
{{--                <h2 class="text-xl font-bold text-gray-800">رمز عبور</h2>--}}
{{--                <p class="text-sm text-gray-500 mt-1">لطفاً رمز عبور دائمی خود را وارد کنید</p>--}}
{{--            </div>--}}
    ...
    <form method="POST" action="{{ route('login.password') }}">
        ...
        <div class="con">
            ...
            <div class="field-set">
                ...
                <input class="form-input" type="password" name="password" placeholder="رمز عبور" required>

                @error('password')
                <p class="text-danger mt-1" style="color: red; font-size: 13px;">{{ $message }}</p>
                @enderror

                @if(session('error'))
                    <p class="text-danger mt-1" style="color: red; font-size: 13px;">{{ session('error') }}</p>
                @endif

                <br>
                <button type="submit" class="log-in">ورود</button>
            </div>
        </div>
    </form>
</div>
