                        ...
                        <div class="card-body">
                            <form action="{{ route('contact-services.store') }}" method="post">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" name="title_fa" class="form-control" placeholder="مثلاً: سیستم اکسیژن" id="title_fa" value="{{ old('title_fa') }}">
                                </div>
                                <div class="mb-2">
                                    <label class="form-label" for="title_en">عنوان انگلیسی</label>
                                    <input type="text" name="title_en" class="form-control" placeholder="e.g. Oxygen System" id="title_en" value="{{ old('title_en') }}">
                                </div>
                                <div class="text-center">
                                    <button type="submit" class="btn btn-success" style="margin:auto;">ثبت سرویس</button>
                                </div>
