                    ...
                    <div class="card-body">
                        <form action="{{route('categories.update', $category)}}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="title" class="form-control" placeholder="ویرایش {{$category->title}}" id="title" value="{{$category->title}}">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="link" class="form-control" placeholder="{{$category->link}}" id="link" value="{{$category->link}}">
                                    <br>
{{--                                    <input type="submit" class="hidden-lg btn btn-sm btn-danger"  id="delete" value="{{$category->link}}">--}}
                            ...
                            <button type="submit" class="btn btn-warning btn-lg btn-block" style="margin-right:2px">تغییر دسته بندی</button>
                        </form>
                    </div>
                </div>
            </div>
