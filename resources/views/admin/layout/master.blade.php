            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <div data-i18n="Layouts">صفحه ی اصلی</div>
                    </a>
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="javascript:void(0);" class="menu-link menu-toggle">
                                ...
                                <div data-i18n="Account Settings">بنر صفحه اول</div>
                            </a>
                            <ul class="menu-sub">
                                <li class="menu-item">
...
{{--                                <div data-i18n="Account Settings"> نوار اصلی</div>--}}
{{--                            </a>--}}
{{--                            <ul class="menu-sub">--}}
{{--                                <li class="menu-item">--}}
{{--                                    <a href="" class="menu-link">--}}
{{--                                        <div data-i18n="Account">جدول دسته بندی </div>--}}
{{--                                    </a>--}}
{{--                                </li>--}}
{{--                                <li class="menu-item">--}}
{{--                                    <a href="" class="menu-link">--}}
{{--                                        <div data-i18n="Notifications">ایجاد دسته بندی</div>--}}
{{--                                    </a>--}}
{{--                                </li>--}}
{{--                            </ul>--}}
{{--                        </li>--}}
                        ...
                        <li class="menu-item">
                            <a href="javascript:void(0);" class="menu-link menu-toggle">
                                ...
                                <div data-i18n="Account Settings"> خدمات-تماس باما </div>
                            </a>
                            <ul class="menu-sub">
                                <li class="menu-item">
...
{{--                                <li class="menu-item">--}}
{{--                                    <a href="{{route('contact-services.create')}}" class="menu-link">--}}
{{--                                        <div data-i18n="Notifications">ایجاد خدمات جدید</div>--}}
{{--                                    </a>--}}
{{--                                </li>--}}
                                <li class="menu-item">
...
{{--                        <div data-i18n="Account Settings">مشاوره</div>--}}
{{--                    </a>--}}
{{--                    <ul class="menu-sub">--}}
{{--                        <li class="menu-item">--}}
{{--                            <a href="" class="menu-link">--}}
{{--                                <div data-i18n="Account">جدول موضوع مشاوره</div>--}}
{{--                            </a>--}}
{{--                        </li>--}}
{{--                        <li class="menu-item">--}}
{{--                            <a href="" class="menu-link">--}}
{{--                                <div data-i18n="Notifications">پیام های دریافتی جهت مشاوره</div>--}}
{{--                            </a>--}}
{{--                        </li>--}}
{{--                        <li class="menu-item">--}}
