                        ...
                        <table class="table table-bordered table-hover text-center align-middle">
                            ...
                            @foreach($contacts as $contact)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('contact.show', $contact) }}" class="btn btn-sm btn-outline-primary">
                                            <i class="bx bx-show"></i> مشاهده
                                        </a>
                                    </td>
                                    <td>
                                        <form action="{{ route('contact.destroy', $contact) }}" method="post" onsubmit="return confirm('آیا مطمئن هستید که می‌خواهید حذف کنید؟');">
                                            @csrf
                                            @method('DELETE')
