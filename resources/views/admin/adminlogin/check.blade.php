...
<div class="limiter" dir="rtl">
    <div class="container-login100">
        <div class="wrap-login100">
            <form class="login100-form validate-form p-l-55 p-r-55 p-t-178" action="{{route('SupportLoginCheckOtp')}}" method="post">
                @csrf
                <span class="login100-form-title">
						ورود به پنل پشتیبانی
					</span>
                <span class="fs-20 fw-light blockquote font-far" style="margin-bottom:20px; color: #28a745;">رمز یکبار مصرف ارسال شده را وارد نمایید</span>
                ...
                {{--                <span class="text-sm text-danger text-rose-500">--}}
                {{--                        {{$message}}--}}
                {{--                    </span>--}}
                ...
                <div class="wrap-input100 validate-input" data-validate ="Please enter password">
                    <input class="input100" type="password" name="password" placeholder="پسورد خود را وارد کنید">
                    <span class="focus-input100"></span>
                </div>
