...
@section('content')
    <div class="container mt-4" dir="rtl">
        ...
        <form action="{{ route('homecare-texts.update', $homecare_text) }}" method="POST" id="homecare-text-form" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                ...
                <input type="text" name="key" class="form-control" value="{{ old('key', $homecare_text->key) }}" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea id="editor-fa" name="body[fa]" class="form-control" rows="6">{!! old('body.fa', $homecare_text->body['fa'] ?? '') !!}</textarea>
            </div>

            <div class="mb-3" dir="ltr">
                <label class="form-label">Body (English)</label>
                <textarea id="editor-en" name="body[en]" class="form-control" rows="6">{!! old('body.en', $homecare_text->body['en'] ?? '') !!}</textarea>
            </div>
