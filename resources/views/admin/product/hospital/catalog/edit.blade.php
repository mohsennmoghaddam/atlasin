        ...
        <form action="{{ route('hospital-catalogs.update', $item) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="title[fa]" class="form-control" value="{{ $item->title['fa'] ?? '' }}" required>
                </div>
                <div class="col-md-6 mb-3" dir="ltr">
                    <label class="form-label">Title (EN)</label>
                    <input type="text" name="title[en]" class="form-control" value="{{ $item->title['en'] ?? '' }}" required>
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                @if($item->file)
                    <div class="mb-2">
                        <a class="btn btn-outline-primary btn-sm" target="_blank" href="{{ asset('storage/'.$item->file) }}">نمایش فایل فعلی</a>
                    </div>
                @endif
