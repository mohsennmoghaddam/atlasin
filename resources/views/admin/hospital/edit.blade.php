...
{{--                            </div>--}}
{{--                        </form>--}}
                        <form action="{{ route('hospitals.update', $hospital) }}" method="POST" enctype="multipart/form-data" dir="rtl">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label class="form-label">نام بیمارستان <span class="text-danger">*</span></label>
                                    <input type="text" name="name" class="form-control text-end" value="{{ old('name', $hospital->name) }}" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">لینک سایت</label>
                                    <input type="url" name="website" class="form-control text-end" value="{{ old('website', $hospital->website) }}">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">توضیح مختصر</label>
                                    <textarea name="description" class="form-control" rows="3">{{ old('description', $hospital->description) }}</textarea>
